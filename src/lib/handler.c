...
PURPLE_EVENTS_HANDLER_ADD_CALLBACK_DEF(im_highlight, ImMessage);
PURPLE_EVENTS_HANDLER_ADD_CALLBACK_DEF(im_action, ImMessage);
PURPLE_EVENTS_HANDLER_ADD_CALLBACK_DEF(chat_message, ChatMessage);
PURPLE_EVENTS_HANDLER_ADD_CALLBACK_DEF(chat_highlight, ChatMessage);
PURPLE_EVENTS_HANDLER_ADD_CALLBACK_DEF(chat_action, ChatMessage);
PURPLE_EVENTS_HANDLER_ADD_CALLBACK_DEF(email, Email);
PURPLE_EVENTS_HANDLER_ADD_CALLBACK_DEF(end_event, EndEvent);
